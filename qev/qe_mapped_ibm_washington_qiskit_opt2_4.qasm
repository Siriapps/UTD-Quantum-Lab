...
creg meas[4];
sx q[113];
rz(2.9832408543339675) q[113];
sx q[113];
rz(-pi) q[113];
sx q[114];
rz(0.00018346261202184522) q[114];
sx q[114];
rz(-pi) q[114];
cx q[114],q[113];
rz(-pi) q[113];
sx q[113];
rz(1.7290684676838177) q[113];
sx q[113];
rz(-pi) q[115];
sx q[115];
rz(1.193352890895877) q[115];
sx q[115];
cx q[115],q[114];
rz(-pi) q[114];
x q[114];
...
rz(-pi) q[113];
sx q[113];
rz(1.5710916761532285) q[113];
sx q[113];
rz(0) q[116];
sx q[116];
rz(6.283164818091459) q[116];
sx q[116];
rz(3*pi) q[116];
cx q[116],q[115];
rz(-pi) q[115];
sx q[115];
rz(0.00012648392257208485) q[115];
sx q[115];
cx q[115],q[114];
rz(-pi) q[114];
sx q[114];
rz(8.693994465325261e-05) q[114];
sx q[114];
sx q[116];
rz(6.283172797715871) q[116];
sx q[116];
cx q[116],q[115];
sx q[115];
rz(1.9481418587705281) q[115];
sx q[115];
rz(-pi) q[115];
sx q[116];
rz(3.1414801994255566) q[116];
sx q[116];
