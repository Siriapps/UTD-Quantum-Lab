...
creg meas[4];
sx q[0];
rz(3.141209327851648) q[0];
sx q[0];
rz(-pi) q[0];
sx q[1];
rz(1.51776713481995) q[1];
sx q[1];
rz(-pi) q[1];
sx q[2];
rz(1.6586864761350473) q[2];
sx q[2];
rz(-pi) q[2];
rz(-pi) q[3];
sx q[3];
rz(2.9869446723204973) q[3];
sx q[3];
cx q[2],q[3];
cx q[1],q[2];
cx q[0],q[1];
sx q[0];
rz(1.571059338034118) q[0];
sx q[0];
rz(-pi) q[0];
sx q[1];
rz(2.810803662729338) q[1];
sx q[1];
rz(-pi) q[1];
rz(-pi) q[2];
sx q[2];
rz(3.1114542287333773) q[2];
sx q[2];
sx q[3];
rz(1.5569834630225037) q[3];
sx q[3];
rz(-pi) q[3];
cx q[2],q[3];
cx q[1],q[2];
cx q[0],q[1];
sx q[0];
rz(1.5704833269356246) q[0];
sx q[0];
rz(-pi) q[0];
sx q[1];
rz(1.5705601997802985) q[1];
sx q[1];
rz(-pi) q[1];
sx q[2];
rz(2.9786860737175402) q[2];
sx q[2];
rz(-pi) q[2];
sx q[3];
rz(1.2461203682995787) q[3];
sx q[3];
rz(-pi) q[3];
