...
creg meas[4];
sx q[113];
rz(2.880335547953555) q[113];
sx q[113];
rz(-pi) q[113];
sx q[114];
rz(2.649570202194953) q[114];
sx q[114];
rz(-pi) q[114];
cx q[114],q[113];
sx q[113];
rz(1.8650764678127656) q[113];
sx q[113];
rz(-pi) q[113];
sx q[115];
rz(3.140656366594486) q[115];
sx q[115];
rz(-pi) q[115];
cx q[115],q[114];
sx q[114];
rz(1.4337475672313467) q[114];
sx q[114];
rz(-pi) q[114];
cx q[114],q[113];
rz(-pi) q[113];
sx q[113];
rz(1.09686747689691) q[113];
sx q[113];
rz(-pi) q[116];
sx q[116];
rz(0.18122555938157525) q[116];
sx q[116];
cx q[116],q[115];
sx q[115];
rz(2.127946114403457) q[115];
sx q[115];
rz(-pi) q[115];
cx q[115],q[114];
rz(-pi) q[114];
sx q[114];
rz(1.571768477955663) q[114];
sx q[114];
rz(-pi) q[116];
sx q[116];
rz(0.28156257568788057) q[116];
sx q[116];
cx q[116],q[115];
rz(-pi) q[115];
sx q[115];
rz(2.153842160655797) q[115];
sx q[115];
rz(-pi) q[116];
sx q[116];
rz(2.8080937754093256) q[116];
sx q[116];
barrier q[116],q[115],q[114],q[113];
